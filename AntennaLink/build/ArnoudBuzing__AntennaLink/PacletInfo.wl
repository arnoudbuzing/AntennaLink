...
PacletObject[
  <|
    "Name" -> "ArnoudBuzing/AntennaLink",
    "Description" -> "Wolfram Language interface to the NEC2 method of moments antenna simulator",
    "Creator" -> "Arnoud Buzing",
    "License" -> "MIT",
    "PublisherID" -> "ArnoudBuzing",
    "Version" -> "1.0.0",
    "WolframVersion" -> "15.0+",
    "PrimaryContext" -> "ArnoudBuzing`AntennaLink`",
    "Extensions" -> {
      {
        "Kernel",
        "Root" -> "Kernel",
